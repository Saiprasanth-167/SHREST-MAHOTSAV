...
app.all('/api/upi-qr', wrapHandler(require('./api/upi-qr.js')));
app.all('/api/upi-config', wrapHandler(require('./api/upi-config.js')));
app.all('/api/validate-utr', wrapHandler(require('./api/validate-utr.js')));
